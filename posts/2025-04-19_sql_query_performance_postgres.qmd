...
This would list the top 5 queries by total execution time. Important fields in this view include:
...
- **pgBadger** (a log analyzer that summarizes slow queries), 
