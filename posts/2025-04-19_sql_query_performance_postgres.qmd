...
**DIAGRAM:** Table Scan vs Index Scan (showing all rows read vs. targeted lookup via B-tree)
:::
...
::: {.callout-note title="Diagram Placeholder"}
**DIAGRAM:** Join Algorithms (Nested Loop, Hash Join, Merge Join) with two tables and arrows showing matching process
:::
...
::: {.callout-note title="Diagram Placeholder"}
**DIAGRAM:** Query Plan Tree Example (nodes for scan, join, filter, sort)
:::
