...
<br>
So here I am, 3AM on a Friday night, staring at a whiteboard covered in post-its and arrows, wondering if I've gotten in way over my head. The AI Alignment Evals Hackathon is ending in less than 8 hours, and I'm still not sure if our idea is brilliant or completely unworkable.
...
![Our initial pitch](/images/game_of_ethics/kickoff-hackathon.png)

"How exactly do you plan to quantify alignment?" one researcher asked, raising a critical question.

With only a couple of days to demonstrate feasibility, our team:

1. Created an initial branching narrative using [Ink](https://www.inklestudios.com/ink/), a scripting language designed for interactive fiction
2. Developed a preliminary scoring system based on eight ethical dimensions
3. Built a basic framework to run LLMs through these scenarios
4. Tested an early prototype on Claude-3.7 Sonnet and GPT-4o

![Our CLI prototype](/images/game_of_ethics/ethi-cli.png)

*Our original whiteboard showing the nascent ethics scoring system. Note the progressive refinement as we iterated on the framework.*
...
After the hackathon (where we received the "Most Novel Evaluation Method" award), we decided this concept warranted deeper exploration. Over the following weeks, we:
