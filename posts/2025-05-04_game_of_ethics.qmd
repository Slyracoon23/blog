...
!["When it's 3 AM debugging your ethical scoring and everything's on fire."](/images/game_of_ethics/this-is-fine.png)
...
![Veronica finalizing our award-winning presentation slides](/images/game_of_ethics/goolge-slides.png)
...
![Our team taking the same ethical tests we gave 
to AI models](/images/game_of_ethics/establishing-baseline.png)

*When you design an ethics test, score it yourself, and somehow your team ends up with the highest "Ethical Human" ratings... purely coincidental.*
...
![Distribution of Overall Ethical Scores by Model](/images/game_of_ethics/overal-distribution.png)

*Distribution of average ethical scores per run by model type, showing the greater variance in human responses compared to AI models*

![Comprehensive Ethics Evaluation Dashboard](/images/game_of_ethics/dashboard.png)

*Our complete dashboard showing overall average scores, verdict distribution, ethical bias across dimensions, consistency metrics, scenario difficulty, and performance distribution*
...
![Ethical Bias Profile by Model (Mean Scores per Axis)](/images/game_of_ethics/ethical-bias.png)

*Heatmap visualization showing the ethical bias profile across all tested models, with humans demonstrating significantly higher scores in the Harm/Care dimension*
...
![Gru meme about ethical scoring debates](/images/game_of_ethics/gru-meme.png)

*The real alignment challenge: Spend 4 hours debating if lying to save a life is +2 Harm/Care or -3 Integrity.*
...
![Our team celebrating after completing the final research paper](/images/game_of_ethics/finial-research-report.png)

*Our team celebrating after completing the final draft of our research paper*

I should mention that we actually had a presentation scheduled for the Ethics in AI Symposium last week, but I completely overslept after pulling an all-night finalizing the research paper! I felt absolutely terrible about it - Torin and Veronica had to present without me. They were gracious about it, but I still owe them both dinner and drinks to make up for it.
...
::: {.callout-note}
## Game of Ethics 2.0 Planning
Our expanded vision includes more nuanced scoring, cross-cultural ethical frameworks, and collaborative decision-making simulations to better capture the full spectrum of human moral reasoning.
:::
